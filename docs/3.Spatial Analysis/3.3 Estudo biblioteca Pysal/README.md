...
A definição de *Spatial lag* dada na biblioteca, para a vizinhança $$i$$ é:

$$ylag_i = \sum_j w_{i,j} y_j$$

Onde:
* $$w_{i,j}$$ é o peso aplicado entre as vizinhanças $$i$$ e $$j$$, e que pode ser visto uma medida de adjacência espacial. No experimento é utiliza-se peso "Queen", que tem origem no movimento da peça em xadrez, ou seja, o peso vai ser igual a 1 para qualquer região adjacente.
...
Sobre *Hot/Cold spots*, é utilizada a estatística **I** de Moran, uma medida da concentração geral dos dados espaciais. É definido como:
...
A definição *Hot/COld spots*, é feita utilizando os quadrantes da estatística de Moran (ver a documentação, muito bem explicada por sinal, para entendimento real do método), e é feita como:
